...
type NebulaTestHost struct {
	Ip   []byte `protobuf:"bytes,1,opt,name=Ip,proto3" json:"Ip,omitempty"`
	Port uint32 `protobuf:"varint,2,opt,name=Port,proto3" json:"Port,omitempty"`
	Seq  uint64 `protobuf:"varint,3,opt,name=Seq,proto3" json:"Seq,omitempty"`
}

func (m *NebulaTestHost) Reset()         { *m = NebulaTestHost{} }
func (m *NebulaTestHost) String() string { return proto.CompactTextString(m) }
func (*NebulaTestHost) ProtoMessage()    {}
func (*NebulaTestHost) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d65afa7693df5ef, []int{8}
}
func (m *NebulaTestHost) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *NebulaTestHost) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_NebulaTestHost.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *NebulaTestHost) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NebulaTestHost.Merge(m, src)
}
func (m *NebulaTestHost) XXX_Size() int {
	return m.Size()
}
func (m *NebulaTestHost) XXX_DiscardUnknown() {
	xxx_messageInfo_NebulaTestHost.DiscardUnknown(m)
}

var xxx_messageInfo_NebulaTestHost proto.InternalMessageInfo

func (m *NebulaTestHost) GetIp() []byte {
	if m != nil {
		return m.Ip
	}
	return nil
...
func (m *NebulaTestHost) GetPort() uint32 {
	if m != nil {
		return m.Port
	}
	return 0
...
func (m *NebulaTestHost) GetSeq() uint64 {
	if m != nil {
		return m.Seq
	}
	return 0
...
type NebulaTestRelay struct {
	RelayToIp   uint32 `protobuf:"varint,1,opt,name=RelayToIp,proto3" json:"RelayToIp,omitempty"`
	RelayFromIp uint32 `protobuf:"varint,2,opt,name=RelayFromIp,proto3" json:"RelayFromIp,omitempty"`
	RelayIp     uint32 `protobuf:"varint,3,opt,name=RelayIp,proto3" json:"RelayIp,omitempty"`
	Seq         uint64 `protobuf:"varint,4,opt,name=Seq,proto3" json:"Seq,omitempty"`
}

func (m *NebulaTestRelay) Reset()         { *m = NebulaTestRelay{} }
func (m *NebulaTestRelay) String() string { return proto.CompactTextString(m) }
func (*NebulaTestRelay) ProtoMessage()    {}
func (*NebulaTestRelay) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d65afa7693df5ef, []int{9}
}
func (m *NebulaTestRelay) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *NebulaTestRelay) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_NebulaTestRelay.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *NebulaTestRelay) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NebulaTestRelay.Merge(m, src)
}
func (m *NebulaTestRelay) XXX_Size() int {
	return m.Size()
}
func (m *NebulaTestRelay) XXX_DiscardUnknown() {
	xxx_messageInfo_NebulaTestRelay.DiscardUnknown(m)
}

var xxx_messageInfo_NebulaTestRelay proto.InternalMessageInfo

func (m *NebulaTestRelay) GetRelayToIp() uint32 {
	if m != nil {
		return m.RelayToIp
	}
	return 0
...
func (m *NebulaTestRelay) GetRelayFromIp() uint32 {
	if m != nil {
		return m.RelayFromIp
	}
	return 0
...
func (m *NebulaTestRelay) GetRelayIp() uint32 {
	if m != nil {
		return m.RelayIp
	}
	return 0
...
func (m *NebulaTestRelay) GetSeq() uint64 {
	if m != nil {
		return m.Seq
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*NebulaTestHost)(nil), "nebula.NebulaTestHost")
	proto.RegisterType((*NebulaTestRelay)(nil), "nebula.NebulaTestRelay")
}
...
var fileDescriptor_2d65afa7693df5ef = []byte{
	...
	,
}
...
func (m *NebulaTestHost) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *NebulaTestHost) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *NebulaTestHost) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.Seq != 0 {
		i = encodeVarintNebula(dAtA, i, uint64(m.Seq))
		i--
		dAtA[i] = 0x18
	}
	if m.Port != 0 {
...
func (m *NebulaTestRelay) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *NebulaTestRelay) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *NebulaTestRelay) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.RelayIp != 0 {
		i = encodeVarintNebula(dAtA, i, uint64(m.RelayIp))
		i--
		dAtA[i] = 0x18
	}
	if m.RelayFromIp != 0 {
...
func (m *NebulaTestHost) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.Seq != 0 {
		n += 1 + sovNebula(uint64(m.Seq))
	}
	return n
}

func (m *NebulaTestRelay) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.RelayIp != 0 {
		n += 1 + sovNebula(uint64(m.RelayIp))
	}
	if m.Seq != 0 {
		n += 1 + sovNebula(uint64(m.Seq))
	}
...
func (m *NebulaTestHost) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NebulaTestHost: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NebulaTestHost: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *NebulaTestRelay) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NebulaTestRelay: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NebulaTestRelay: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RelayIp", wireType)
			}
			m.RelayIp = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
